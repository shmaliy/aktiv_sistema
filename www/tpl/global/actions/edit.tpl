...
<form action="/actions.php?id=edit&ssid={ID}" method="POST" target="main">
<table cellpadding='0' cellspacing='1' width="99%" bgcolor="#dedede">
<tr bgcolor="#ffffff">
      <td align="left"><table><tr bgcolor="#ffffff"><td width="15" align="left"><img src="/images/settings.gif" border="0"></td><td align="left"><strong>Редактировать событие</strong></td></tr></table></td>
</tr>
</table>
<table cellpadding='3' cellspacing='1' width="99%" bgcolor="#dedede">
    ...
    <tr>
      <td style="background-color: #EBEBEB;" class="tsimple" align="left" width="150">Текст события</td>
