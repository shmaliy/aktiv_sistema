...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../../../images/public/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../../../images/public/');	//accept relative path only
	...
	define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,txt,doc,ppt,rar,zip,xls,tif,tiff,swf,rtf,pps'); // 
