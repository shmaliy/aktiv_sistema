...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../../../images/public/'); 
	define('CONFIG_SYS_ROOT_PATH', '../../../../../images/public/');	//the root folder where the files would be uploaded to
	...
	//URL Declartions
		 ...
		 *
		 */
	define('CONFIG_URL_PREVIEW_ROOT', $_SERVER['DOCUMENT_ROOT'].'/');
