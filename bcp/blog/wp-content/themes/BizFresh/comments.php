	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li class="<?php echo $oddcomment; ?>" id="comment-<?php comment_ID() ?>">
          ...
          <?php } ?>
			...
			<span class="commentmetadata"><a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('d M Y') ?> в <?php comment_time() ?></a> <?php edit_comment_link('','',''); ?></span>
...
<p><input name="submit" type="submit" id="submit" tabindex="5" value="Добавить" class="" />
